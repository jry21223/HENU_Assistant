...
description: 河南大学校园助手，支持课表查询、选课状态/规划、图书馆预约、空教室查询、研讨室预约（与 mcp-server 能力对齐）
---
...
当用户询问课表/课程/图书馆/空教室/教室/自习室/研讨室相关需求时，使用 `bash` 执行：
...
- `schedule_query --view day --target_date "YYYY-MM-DD"`
...
- `library_query --view seats --location "<区域>" --target_date "YYYY-MM-DD" --preferred_time "08:00"`
...
- `seminar_query --view rooms --target_date "YYYY-MM-DD" --members 0 [--library_names "<馆舍名>"]`
- `seminar_query --view detail --area_id "<房间ID>" [--target_date "YYYY-MM-DD"]`
...
- `seminar_reserve --area_id "<房间ID>" --target_date "YYYY-MM-DD" --start_time "14:00" --end_time "16:00" --group_name "<组名>" --title "<主题>" --content "<超过10字的申请说明>" --mobile "<手机号>"`
